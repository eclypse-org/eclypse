...
def get_keyword_spotting(
    application_id: str = "KeywordSpotting",
    ...
    """Get the keyword spotting application.
    ...
    Args:
        ...
        flows (Literal["default"] | list[list[str]]):
            ...
            benchmark's built-in audio-processing flow.
        store_step (bool):
    ...
    Returns:
        Application: The configured keyword spotting application.
    ...
    edge_requirements = [
        (
            "SensorService",
            "PreprocessService",
            {"symmetric": True, "latency": 5, "bandwidth": 5},
        ),
        (
            "PreprocessService",
            "InferenceService",
        ...
        (
            "SensorService",
            "InferenceService",
            {"symmetric": True, "latency": 7, "bandwidth": 4},
        ),
        (
            "InferenceService",
            "ActionService",
