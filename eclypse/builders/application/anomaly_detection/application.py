...
def get_anomaly_detection(
    application_id: str = "AnomalyDetection",
    ...
    """Get the anomaly detection application.
    ...
    Args:
        ...
        flows (Literal["default"] | list[list[str]]):
            ...
            benchmark's built-in telemetry-processing flow.
        store_step (bool):
    ...
    Returns:
        Application: The configured anomaly detection application.
