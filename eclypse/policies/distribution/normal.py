"""Normal-distribution resource policy."""
...
def normal(
    *,
    ...
    Args:
        ...
        node_distribution (tuple[float, float]): Default ``(mean, std)`` pair used
    ...
    Returns:
        UpdatePolicy: A graph update policy applying Gaussian multiplicative noise.
    """
