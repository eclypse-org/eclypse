"""Pareto multiplier distribution policy."""
...
def pareto(
    *,
    ...
    validate_distributions(
        ...
        checks=[(lambda distribution: distribution > 0, "must be strictly positive.")],
    )
    return build_sampled_distribution_policy(
        ...
        sampler=lambda rnd, distribution: rnd.paretovariate(distribution),
    )
