"""Gamma-distribution resource policy."""
...
def gamma(
    *,
    ...
    Args:
        ...
        node_distribution (tuple[float, float]): Default ``(shape, scale)`` pair
    ...
    Returns:
        UpdatePolicy: A graph update policy applying gamma multiplicative noise.
    """
