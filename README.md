...
> ⚠️ **Disclaimer**
>
> This branch is **not the main branch** of the project.  
> It is intended solely to contain the **outputs of example runs** executed with the **ECLYPSE** library up to version **0.6.18 (inclusive)**.  
> Running the code in this branch is **only supported with version 0.6.18 or earlier**, and **may not function correctly** with later releases.
